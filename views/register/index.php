<style>
    ...
    #main_header_icon {
        height: 60px;
        width: 70px;
        background: url(public/images/slices.png) -867px -83px;
        display: block;
        margin: auto;
    }
    ...
    .check_label.checked{
        background: url(public/images/slices.png)-193px -82px #3542bf;
        border:none;
    }
...
<div id="main">
    ...
    <div id="main_header">
        ...
        <span>به دیجی کالا بپیوندید</span>
        <div class="main_header_bottom_right">
            <div>
                <label class="label_register" >پست الکترونیکی :</label>
                <input class="input_register" type="text" placeholder="Email:">
            </div>
            <div>
                <label class="label_register" >کلمه عبور :</label>
                <input class="input_register" type="password" placeholder="password:">
            </div>
            <div class="check_div">
                <label class="check_label"></label>
                <input class="check_input" type="checkbox">قوانین را مطالعه نموده و با آن موافقت مینمایم</div>
            <div class="check_div">
                <label class="check_label"></label>
